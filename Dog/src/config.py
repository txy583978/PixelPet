...
class Config:
    # ==================== Sprite 配置 ====================
    sprite_path: str = "assets/dog.png"
    frame_width: int = 32
    frame_height: int = 32
    sprite_scale: float = 1.7
    sprite_cols: int = 4
    sprite_rows: int = 9
    ...
    sound_files: List[str] = field(default_factory=lambda: ["bark.wav", "bark2.wav", "whine.wav"])
