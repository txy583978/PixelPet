...
class Config:
    # ==================== Sprite 配置 ====================
    sprite_path: str = "assets/pig.png"
    frame_width: int = 32
    frame_height: int = 32
    ...
    sound_files: List[str] = field(default_factory=lambda: ["oink.wav", "oink2.wav"])
    sound_min_interval: float = 6.0
    sound_max_interval: float = 12.0
    sound_burst_min: int = 3
    sound_burst_max: int = 4
    sound_burst_interval: float = 0.5
