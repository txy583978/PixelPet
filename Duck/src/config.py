...
class Config:
    # ==================== Sprite 配置 ====================
    sprite_path: str = "assets/duck.png"
    frame_width: int = 16
    frame_height: int = 16
    sprite_scale: float = 2.6
    sprite_cols: int = 4
    sprite_rows: int = 14
    ...
    frame_map: Dict[str, Dict[int, int]] = field(default_factory=lambda: {
        "walk":  {0: 3, 1: 2, 2: 0, 3: 1},
        "idle":  {0: 3, 1: 2, 2: 0, 3: 1},
        "eat":   {0: 6, 1: 6, 2: 6, 3: 6},
    ...
    sound_files: List[str] = field(default_factory=lambda: ["quack.wav"])
    sound_min_interval: float = 4.8
    sound_max_interval: float = 9.0
    sound_burst_min: int = 3
    sound_burst_max: int = 5
    sound_burst_interval: float = 0.4
